...
This file owns **the belief and its correction**. The rules that make these assumptions
unreachable are in `../01_ACTIVE_RULES/`; the incidents are in `ERROR_LEDGER.md`.
