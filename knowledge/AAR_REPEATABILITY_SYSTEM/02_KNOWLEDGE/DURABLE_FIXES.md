...
This file owns **the control and its proof**. Controls that are *enforced* appear as gates
in `../01_ACTIVE_RULES/` and as executable checks in `../03_REGRESSION/validators.py`;
the `E-###` identifiers below map to `AAR-R###` via `ID_CROSSWALK.md`.
