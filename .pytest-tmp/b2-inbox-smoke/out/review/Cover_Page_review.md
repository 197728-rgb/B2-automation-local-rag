...
- **facility_name** — `FILL` — value='SmokeCo Date: 2026-05-07 Cover Page Facility: Smoke' conf=0.95 — selected highest-confidence local evidence

## Sources
- evidence.txt

## Retrieved context
- evidence.txt chunk 1 score 425: B24 RL2 Facility: SmokeCo Date: 2026-05-07 Cover Page Facility: Smoke

## Field suggestions
- facility_name: SmokeCo Date: 2026-05-07 Cover Page Facility: Smoke (evidence.txt chunk 1)
